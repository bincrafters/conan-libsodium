...
set_property(TARGET sodium PROPERTY INTERFACE_INCLUDE_DIRECTORIES
    ${CONAN_INCLUDE_DIRS_LIBSODIUM}
    $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_LIBSODIUM_DEBUG}>)
set_property(TARGET sodium PROPERTY INTERFACE_LINK_LIBRARIES
    ${CONAN_LIBS_LIBSODIUM} ${CONAN_SHARED_LINKER_FLAGS_LIBSODIUM_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBSODIUM_LIST}
    $<$<CONFIG:Release>:${CONAN_LIBS_LIBSODIUM_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST}>
    $<$<CONFIG:RelWithDebInfo>:${CONAN_LIBS_LIBSODIUM_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST}>
    $<$<CONFIG:MinSizeRel>:${CONAN_LIBS_LIBSODIUM_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBSODIUM_RELEASE_LIST}>
    $<$<CONFIG:Debug>:${CONAN_LIBS_LIBSODIUM_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_LIBSODIUM_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBSODIUM_DEBUG_LIST}>)
set_property(TARGET sodium PROPERTY INTERFACE_COMPILE_DEFINITIONS
    ${CONAN_COMPILE_DEFINITIONS_LIBSODIUM}
    $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_LIBSODIUM_RELEASE}>
    $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_LIBSODIUM_DEBUG}>)
set_property(TARGET sodium PROPERTY INTERFACE_COMPILE_OPTIONS
    ${CONAN_C_FLAGS_LIBSODIUM_LIST} ${CONAN_CXX_FLAGS_LIBSODIUM_LIST}
    $<$<CONFIG:Release>:${CONAN_C_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBSODIUM_RELEASE_LIST}>
    $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBSODIUM_RELEASE_LIST}>
    $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_LIBSODIUM_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBSODIUM_RELEASE_LIST}>
